        ...
        >
            ...
            >
                ...
                <p
                    ...
                    '
                >
                    Explore carefully crafted projects, designed with passion and care to deliver smooth, impactful, and enjoyable experiences.
                </p>
            </div>
            <div
                ref={viewRef}
            ...
            >
                ...
                >
                    <LinkComponent
                        ...
                        className={`${list === 'list'? 'bg-[var(--accent)] text-[var(--accent)] border-[var(--accent)] rounded-full !py-[29px] !px-6 overflow-hidden xl:scale-100 scale-75' : 'bg-[var(--black)] text-[var(--accent)] xl:after:bg-[var(--accent)] border-[var(--accent)] rounded-full !py-[29px] !px-6 overflow-hidden xl:scale-100 scale-75'}`}
                    ...
                    <LinkComponent
                        ...
                        className={`${list === 'grid'? 'bg-[var(--accent)] text-[var(--accent)] border-[var(--accent)] rounded-full !p-6 overflow-hidden xl:scale-100 scale-75' : 'bg-[var(--black)] text-[var(--accent)] xl:after:bg-[var(--accent)] border-[var(--accent)] rounded-full !p-6 overflow-hidden xl:scale-100 scale-75'}`}
                        shadowColor='var(--accent)'
